...
final class Version20210115155854 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity_publics ADD CONSTRAINT FK_7861611C81C06096 FOREIGN KEY (activity_id) REFERENCES activity (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE activity ADD user_id INT NOT NULL, ADD type_activity_id INT NOT NULL, ADD state_id INT NOT NULL');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE activity ADD CONSTRAINT FK_AC74095ACAD9B707 FOREIGN KEY (type_activity_id) REFERENCES type_activity (id)');
        ...
        $this->addSql('CREATE INDEX IDX_AC74095ACAD9B707 ON activity (type_activity_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE activity DROP FOREIGN KEY FK_AC74095ACAD9B707');
        ...
        $this->addSql('DROP INDEX IDX_AC74095ACAD9B707 ON activity');
        $this->addSql('DROP INDEX IDX_AC74095A5D83CC1 ON activity');
        $this->addSql('ALTER TABLE activity DROP user_id, DROP type_activity_id, DROP state_id');
